...
class GameFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            ...
            gameResult = it.getParcelable(RESULT) ?: GameResult()
        }
    ...
    private fun play() {
        ...
        if (currentRound != null) {
            ...
            gameResult.hits = hits
            gameResult.totalGameTime = totalGameTime

            val showFragmentIntent = Intent(activity, ShowScreenActivity::class.java)
            showFragmentIntent.putExtra(EXTRA_SETTINGS,settings)
            showFragmentIntent.putExtra(RESULT,gameResult)
            startActivity(showFragmentIntent);
/*
